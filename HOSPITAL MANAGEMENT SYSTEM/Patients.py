...
class PATIENTS:
    def products(self):
        ...
        # product
        Label(self.product,text='DARUL-SHIFA HOSPITAL | MANAGE PATIENTS',bg='#015',fg='white',bd=3,relief='flat',
        ...
        Label(self.product,text='PatientID',bg='white',fg='#6c63ff',font=('Verdana',19,'bold')
              ).place(x=10,y=100)
        ...
        # product name
        Label(self.product,text='PatientName',bg='white',fg='#6c63ff',font=('Verdana',19,'bold')
              ).place(x=10,y=200)
        ...
        # shifts
        Label(self.product, text='Blood-Type', bg='white', fg='#6c63ff', font=('Verdana', 19, 'bold')
              ).place(x=650, y=200)
        self.blood_var=StringVar()
        self.blood_var.set('BloodType')
        self.lists=['Get','Normal','ITS']
        self.bloods=ttk.Combobox(self.product,value=self.lists,textvariable=self.blood_var,font=('Verdana',15,'bold'),justify=CENTER)
        self.bloods.place(x=650,y=250,width=180)
        ...
        self.departs.place(x=650, y=350, width=190)
        ...
        self.search.insert(0,'Search PatienID')
        ...
        self.tree=ttk.Treeview(self.frame_tree,yscrollcommand=scrollbar.set,
                               columns=('PaID','Patient-Name','Age','Mobile','Email','Gender','Address','Blood-Type','DoctorID'))
        ...
        self.tree.column('Patient-Name',width=220)
        ...
        self.tree.column('Blood-Type',width=130,anchor=CENTER)
        self.tree.column('DoctorID',width=210,anchor=CENTER)

        self.tree.heading('PaID',text='PtaientID')
        ...
        self.tree.heading('DoctorID',text='DoctorID')
