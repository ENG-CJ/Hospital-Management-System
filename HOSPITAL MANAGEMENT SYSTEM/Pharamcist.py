...
class PHARMA:
    def products(self):
        ...
        Label(self.product,text='PharmacistID',bg='white',fg='#6c63ff',font=('Verdana',19,'bold')
              ).place(x=10,y=100)
        ...
        # product name
        Label(self.product,text='Pharmacist-Name',bg='white',fg='#6c63ff',font=('Verdana',19,'bold')
              ).place(x=10,y=200)
        ...
        self.search.insert(0,'Search PharmaID')
        ...
        self.tree=ttk.Treeview(self.frame_tree,yscrollcommand=scrollbar.set,
                               columns=('PharmaID','Pharma-Name','Age','Mobile','Email','Gender','Address'))
      ...
      #   ^ Configuration
        ...
        self.tree.column('PharmaID',width=80)
        self.tree.column('Pharma-Name',width=320)
        self.tree.column('Age',width=110,anchor=CENTER)
        self.tree.column('Mobile',width=200,anchor=CENTER)
        self.tree.column('Email',width=280,anchor=CENTER)
        self.tree.column('Gender',width=200,anchor=CENTER)
        self.tree.column('Address',width=300,anchor=CENTER)


        self.tree.heading('PharmaID',text='PharmaID')
        self.tree.heading('Pharma-Name',text='Pharma-Name')
