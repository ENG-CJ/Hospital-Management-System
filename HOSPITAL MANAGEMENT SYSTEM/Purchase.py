...
class PURCHASE:
    def products(self):
        ...
        # product
        Label(self.product,text='DARUL-SHIFA HOSPITAL | MANAGE PHARMACIST',bg='#015',fg='white',bd=3,relief='flat',
        ...
        Label(self.product,text='PurchaseID',bg='white',fg='#6c63ff',font=('Verdana',19,'bold')
              ).place(x=10,y=100)
        self.purID=Entry(self.product,bg='#c0b6ff',fg='black',font=('Verdana',15,'bold'),
        ...
        self.company=Entry(self.product,bg='#c0b6ff',fg='black',font=('Verdana',15,'bold'),
                         bd=4,relief='sunken',width=15)
        self.company.place(x=10,y=250)

        # price
        Label(self.product,text='MedName',bg='white',fg='#6c63ff',font=('Verdana',19,'bold')
              ).place(x=10,y=300)
        self.medname=Entry(self.product,bg='#c0b6ff',fg='black',font=('Verdana',15,'bold'),
                         bd=4,relief='sunken',width=15)
        self.medname.place(x=10,y=350)

        # quantity
        Label(self.product, text='Cost', bg='white', fg='#6c63ff', font=('Verdana', 19, 'bold')
              ).place(x=320, y=100)
        self.cost = Entry(self.product, bg='#c0b6ff', fg='black', font=('Verdana', 15, 'bold'),
                           bd=4, relief='sunken', width=15)
        ...
        Label(self.product, image=self.baner, bg='white', bd=0).place(x=790, y=100)


        #Date
        Label(self.product, text='Type', bg='white', fg='#6c63ff', font=('Verdana', 19, 'bold')
              ).place(x=320, y=200)
        self.type = Entry(self.product, bg='#c0b6ff', fg='black', font=('Verdana', 15, 'bold'),
                           bd=4, relief='sunken', width=15)
        ...
        self.search.insert(0,'Search PurchID')
        ...
        self.tree.column('PurID',width=100)
        self.tree.column('Company',width=300)
        self.tree.column('Medname',width=300,anchor=CENTER)
        self.tree.column('Cost',width=200,anchor=CENTER)
        self.tree.column('Type',width=290,anchor=CENTER)
        self.tree.column('Date',width=300,anchor=CENTER)


        self.tree.heading('PurID',text='PurchaseID')
